                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo e($signature->where(['deleted' => '0', 'user_id' => auth()->user()->id])->count()); ?></div>
                                        <div>My Signature(s)</div>
                                    </div>
                                </div>
                            </div>
                            <a href="<?php echo e(route('adviserSignature')); ?>">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                        ...
                        <div class="chat-panel panel panel-default">
                            <div class="panel-heading">
                                ...
                                <div class="pull-right">
                                    <?php echo e($signature->where(['user_id' => auth()->user()->id, 'used_by' => null, 'deleted' => '0'])->count()); ?>/<?php echo e($signature->where(['user_id' => auth()->user()->id, 'deleted' => '0'])->count()); ?>
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php foreach($signature->where(['user_id' => auth()->user()->id, 'used_by' => null, 'deleted' => '0'])->get() as $sign): ?>
                                            <tr>
