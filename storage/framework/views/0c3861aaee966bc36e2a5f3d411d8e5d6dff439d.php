                ...
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4><i class="fa fa-comments-o fa-fw"></i> Messages | <a href="<?php echo e(route('adviserInbox')); ?>" class="small"> Back to inbox</a></h4>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <div class="col-lg-6 col-lg-offset-3">
                                    <div class="chat-panel panel panel-default" id="chat">
                                            ...
                                            <ul class="chat list-unstyled">
                                                <?php if($chat->count() != 0): ?>
                                                    <?php foreach($chat as $msg): ?>
                                                        <li>
                                                            <?php if($msg->sender != auth()->user()->id): ?>
                                                                <div class="text-left">
                                        ...
                                        <div class="panel-footer">
                                                <?php echo e(Form::open(['method' => 'post', 'url' => route('messageSend', [encrypt($sender), $chat_id])])); ?>
