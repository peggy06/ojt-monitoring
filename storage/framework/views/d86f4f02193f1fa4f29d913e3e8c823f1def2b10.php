...
<input id="pac-input" class="controls form-control" type="text" placeholder="Search your company here...">
<div id="map">
    <span id="wait" class="lead">&nbsp;&nbsp;Please wait for a while ...</span>
</div>
<script>
        ...
        var c = function (pos) {
            ...
            searchBox.addListener('places_changed', function() {
                ...
                places.forEach(function(place) {
                    ...
                    document.getElementById("addCompany").setAttribute("style", "display: block");
                });
