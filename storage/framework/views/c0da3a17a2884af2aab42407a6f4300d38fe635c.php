        ...
        <li>
            <a href="">
                ...
                <?php if($messages->where(['receiver' => auth()->user()->id, 'deleted' => 0, 'new' => 1])->count() != 0): ?>
                    <sup class="badge small" id="requestBadge"><?php echo e($messages->where(['receiver' => auth()->user()->id, 'deleted' => 0, 'new' => 1])->count()); ?></sup>
                <?php endif; ?>
            </a>
        </li>
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-tasks dropdown-scroll">
                <iframe src="<?php echo e(route('studentLoadNotification')); ?>" frameborder="0" height="100%" width="100%" style="overflow-x: hidden"></iframe>
            </ul>
        </li>
        <!-- /.dropdown -->
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                ...
                <li class="divider"></li>
                <li><a href="<?php echo e(route('studentLogout')); ?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                </li>
            </ul>
        </li>
        <!-- /.dropdown -->
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="divider">&nbsp;</li>
                <li>
                    <a href="<?php echo e(route('studentDashboard')); ?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                </li>
                <li>
                    <a href="<?php echo e(route('studentInbox')); ?>"><i class="fa fa-inbox fa-fw"></i> Inbox</a>
                </li>
            </ul>
        </div>
    </div>
